package com.example.factory_news.adapters
...
import com.example.factory_news.R
...
class RecyclerAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val itemPicture: ImageView = itemView.findViewById(R.id.urlToImage)

        //Brine o click events-ima.
        init {
